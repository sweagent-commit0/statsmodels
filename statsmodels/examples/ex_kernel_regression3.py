...
if __name__ == '__main__':
    ...
    model = nparam.KernelCensoredReg(endog=[y_cens], exog=[x, x2], reg_type='ll', var_type='cc', bw='aic', censor_val=c_val[:, None])
    sm_bw = model.bw
    sm_mean, sm_mfx = model.fit()
    model2 = nparam.KernelReg(endog=[y_cens], exog=[x, x2], reg_type='ll', var_type='cc', bw='aic')
